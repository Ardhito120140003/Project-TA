    ...
    const content = [
        {
            ...
            render: () => (
                <View style={{ flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                    <CardCircular style={{ flex: 1 }} value={doValue} maxValue={7} label="DO Sensor" />
                    <CardCircular style={{ flex: 2 }} value={tempValue} maxValue={36} label="Temperatur" />
                </View>
            )
        },
        { key: "frequencyBar", render: () => (<CardBar value={frequencyValue} maxValue={98} label="Frekuensi Aerator" title="Kecepatan Aerator" />) },
        { key: "frequencyLog", render: () => <LogCard logs={logData} title="Log Aerator" /> },
    ];
